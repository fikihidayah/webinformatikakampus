      ...
      <div class="col-md-9">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="mb-5">
              <img src="{{ $news->image }}" alt="" class="img-fluid img-preview">
            </div>
          ...
          <div class="card-body">
            <fieldset class="form-group">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="is_published" id="ya" value="1"
...
@section('optJS')
  ...
  <script>
    ...
    if (old('category')) {
        ...
        $data = $news->category->pluck('id');
    }
    @endphp
    const oldValCategory = {{ Js::from($data) }};
